...
Acceptance-review refinements: explicit multiline blocks and selective JAQT queries now improve the cycle code’s readability. The latest full relevant regression suite passes 105/105; EVD-27 records preserved ordering, backup coverage and plain-data report contracts. Human cycle acceptance is still pending.
