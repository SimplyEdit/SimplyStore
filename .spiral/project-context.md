...
Current active Spiral cycle: `.spiral/cycles/CYC-004.md` (`Full Startup Recovery Harness`). Latest accepted Spiral cycle: `.spiral/cycles/CYC-003.md` (`Startup Recovery Repair`).
